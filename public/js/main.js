...
// console.log(task);
var status;
var taskType = task.match(/^#buy|lol|LOL|#lol|#Funny|#funny|funny|#confused|#Confused|confused$/);
  ...
  var htmlToAppend = 
    '<div class="card-container col-sm-6">'+
      '<div class="response" "form-group">'+
        // '<img src="img/'+userLocation+'.png">'+
          '<h2>'+negativeWordList+'? Like this?<br /></h2>'+
          '<h4>@ '+timeNow+'</h4>'+
          '<h4>'+userLocation+'</h4>'+
        '<label class="btn btn-default btn-file">'+
        '<span class="glyphicon glyphicon-upload"></span>'+
...
function fanciesArtist(timeNow, userLocation){
  ...
  var htmlToAppend = 
    // '<div class="card-container col-sm-6">'+
      '<div class="response" "form-group">'+
        // '<img src="img/'+userLocation+'.png">'+
          '<h2> It\'s randomization through code, generated by <a href="www.osamasehgol.com">Osama Sehgol</a><br /></h2>'+
          '<h4>@ '+timeNow+'</h4>'+
          '<h4>'+userLocation+'</h4>'+
        '<label class="btn btn-default btn-file">'+
        '<span class="glyphicon glyphicon-upload"></span>'+
...
function whatsFunny(timeNow, userLocation){
  ...
  var htmlToAppend = 
    // '<div class="card-container col-sm-6">'+
      '<div class="response" "form-group">'+
        // '<img src="img/'+userLocation+'.png">'+
          '<h2> What\'s funny is, I can\'t see the bird in this image<br /></h2>'+
          '<h4>@ '+timeNow+'</h4>'+
          '<h4>'+userLocation+'</h4>'+
        '<label class="btn btn-default btn-file">'+
        '<span class="glyphicon glyphicon-upload"></span>'+
